    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-6">
        ...
        <div className="p-4 rounded-xl bg-zinc-900/60 border border-zinc-800 flex items-start gap-3.5">
          <div className="w-10 h-10 rounded-xl bg-rose-950/60 border border-rose-800/50 text-rose-400 flex items-center justify-center flex-shrink-0">
          ...
          <div>
            ...
            <span className="block text-xl sm:text-2xl font-extrabold text-white mt-0.5">
        ...
        {/* Breaths Taken */}
        <div className="p-4 rounded-xl bg-zinc-900/60 border border-zinc-800 flex items-start gap-3.5">
          <div className="w-10 h-10 rounded-xl bg-cyan-950/60 border border-cyan-800/50 text-cyan-400 flex items-center justify-center flex-shrink-0">
        ...
        {/* Sleep Duration */}
        <div className="p-4 rounded-xl bg-zinc-900/60 border border-zinc-800 flex items-start gap-3.5">
          <div className="w-10 h-10 rounded-xl bg-violet-950/60 border border-violet-800/50 text-violet-400 flex items-center justify-center flex-shrink-0">
        ...
        <div className="p-4 rounded-xl bg-zinc-900/60 border border-zinc-800 flex items-start gap-3.5">
          <div className="w-10 h-10 rounded-xl bg-amber-950/60 border border-amber-800/50 text-amber-400 flex items-center justify-center flex-shrink-0">
        ...
        {/* Solar Orbits */}
        <div className="p-4 rounded-xl bg-zinc-900/60 border border-zinc-800 flex items-start gap-3.5">
          <div className="w-10 h-10 rounded-xl bg-emerald-950/60 border border-emerald-800/50 text-emerald-400 flex items-center justify-center flex-shrink-0">
        ...
        {/* Eye Blinks */}
        <div className="p-4 rounded-xl bg-zinc-900/60 border border-zinc-800 flex items-start gap-3.5">
          <div className="w-10 h-10 rounded-xl bg-indigo-950/60 border border-indigo-800/50 text-indigo-400 flex items-center justify-center flex-shrink-0">
      ...
      <div className="mt-6 p-4 rounded-xl bg-[#09090b] border border-zinc-800 text-xs text-zinc-400 flex items-start gap-2.5">
        <Info className="w-4 h-4 text-indigo-400 flex-shrink-0 mt-0.5" />
        <p className="leading-relaxed">
          <strong className="text-zinc-300">Calculation Note:</strong> Time-based totals are calculated from calendar dates and may vary depending on the exact interpretation of elapsed time. For seconds, minutes, and hours, calculations reflect standard calendar-day intervals (24 hours per calendar day) unless an exact birth time was specified in the calculator. Biological and cosmic statistics are scientific estimations based on global demographic averages.
        </p>
      </div>
    </div>
  );
