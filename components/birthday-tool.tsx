...
export function BirthdayTool() {
  ...
  return (
    ...
    >
      ...
      {/* Birthday Input Bar */}
      <div className="mt-6 p-4 sm:p-5 rounded-xl bg-zinc-900/60 border border-zinc-800">
        ...
        <div className="grid grid-cols-3 gap-3">
          <div>
            <label htmlFor="bday-tool-month" className="block text-xs font-semibold text-zinc-400 mb-1">Month</label>
            <select
              id="bday-tool-month"
              value={bMonth}
              onChange={(e) => setBMonth(Number(e.target.value))}
              className="w-full h-11 px-3 bg-[#09090b] border border-zinc-700 rounded-lg text-sm font-medium text-white"
            >
          ...
          <div>
            <label htmlFor="bday-tool-day" className="block text-xs font-semibold text-zinc-400 mb-1">Day</label>
            <select
              id="bday-tool-day"
              value={bDay}
          ...
          <div>
            <label htmlFor="bday-tool-year" className="block text-xs font-semibold text-zinc-400 mb-1">Year</label>
            <select
              id="bday-tool-year"
              value={bYear}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-6">
        ...
        <div className="p-4 rounded-xl bg-amber-950/40 border border-amber-900/60">
        ...
        <div className="p-4 rounded-xl bg-emerald-950/40 border border-emerald-900/60">
        ...
        <div className="p-4 rounded-xl bg-zinc-900/60 border border-zinc-800">
          ...
          <span className="block text-lg font-bold text-white mt-1 flex items-center gap-1.5">
        ...
        <div className="p-4 rounded-xl bg-zinc-900/60 border border-zinc-800">
          ...
          <span className="block text-lg font-bold text-white mt-1 flex items-center gap-1.5">
            <Award className="w-4 h-4 text-amber-400" /> Age {goldenBday.age} ({goldenBday.year})
          </span>
          <p className="text-xs text-zinc-400 mt-1">
        ...
        <div className="p-4 rounded-xl bg-zinc-900/60 border border-zinc-800">
          ...
          <span className="block text-lg font-bold text-white mt-1 flex items-center gap-1.5">
            <Sparkles className="w-4 h-4 text-purple-400" /> {halfBday.monthName} {halfBday.day}
          </span>
          <p className="text-xs text-zinc-400 mt-1">
