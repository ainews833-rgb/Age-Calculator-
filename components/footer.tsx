...
export function Footer() {
  ...
  return (
    <footer className="no-print border-t border-zinc-800/90 bg-[#18181b]/90 mt-16 py-12 transition-colors">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <span className="block text-xs font-bold uppercase tracking-wider text-white mb-3">
              Tools & Features
            </span>
            <ul className="space-y-2 text-xs text-zinc-400">
              ...
              <li>
                <a href="#birthday-countdown" className="hover:text-indigo-400 transition-colors">
                  Birthday Countdown
                </a>
              </li>
              <li>
                <a href="#date-difference" className="hover:text-indigo-400 transition-colors">
                  Date Difference Calculator
                </a>
              </li>
              <li>
                <a href="#birthday-calc" className="hover:text-indigo-400 transition-colors">
                  Dedicated Birthday Tool
                </a>
              </li>
              <li>
                <a href="#milestones" className="hover:text-indigo-400 transition-colors">
                  Age Milestones
                </a>
              </li>
              <li>
                <a href="#life-stats" className="hover:text-indigo-400 transition-colors">
                  Life in Numbers
                </a>
              </li>
            </ul>
        ...
        {/* Bottom Bar */}
        <div className="mt-10 pt-6 border-t border-zinc-800 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-zinc-400">
